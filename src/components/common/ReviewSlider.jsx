...
function ReviewSlider(){
  ...
  return (
    <div className="w-full text-white">
      <div className="h-[184px] max-w-maxContent">
              ...
              <SwiperSlide key = {i}>
                ...
                <div className="flex flex-col gap-3 bg-richblack-800 p-3 text-[14px] text-richblack-25">
                  ...
                  <div className="flex items-center gap-2 ">
                    <h3 className="font-semibold" style={{color: "yellow"}}> {review.rating.toFixed(1)} </h3>
                    <ReactStars count={5} value={review.rating} size={20} edit={false} activeColor="yellow" emptyIcon={<FaStar />} fullIcon={<FaStar />} />
                  </div>
