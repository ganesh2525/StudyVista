  ...
  return (
    <div>
        ...
        <div className="relative mx-auto flex flex-col w-11/12 max-w-maxContent items-center text-white justify-between gap-8">
            ...
            <div className="mx-3 my-7 shadow-[10px_-5px_50px_-5px]">
                <video
                muted
                loop
                autoPlay
                ...
                <div className="mb-10 mt-[-100px] flex flex-col justify-between gap-7 lg:mt-20 lg:flex-row lg:gap-0">
                    ...
                    <div className="flex flex-col items-start gap-10 lg:w-[40%]">
                        <div className="text-[16px]">
                            The modern StudyVista is the dictates its own terms. 
        ...
        {/* Section3 - Jobs that in demand */}
        <div className="relative mx-auto my-20 flex w-11/12 max-w-maxContent flex-col items-center justify-between gap-8 ring-richblack-800 text-white">
            <InstructorSection/>
            <h1 className="text-center text-3xl font-semibold mt-8">Review From Other Leaners</h1>
            <ReviewSlider/>
        </div>
